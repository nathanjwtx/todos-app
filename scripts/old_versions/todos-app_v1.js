...
// summary.textContent = `You have ${incompleteTodos.length} incomplete Todos left`
...
//     todoPara.textContent = todo.body
//     document.querySelector('body').appendChild(todoTitle)
...
const displayTodos = function (todos, filter) {
  ...
  filteredTodos.forEach(function (todo) {
    ...
    // }
    // summary.textContent = `You have ${(todos.length - completeTodos)} incomplete Todos left`
